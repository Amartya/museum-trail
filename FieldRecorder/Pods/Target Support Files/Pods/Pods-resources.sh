...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "EstimoteIndoorSDK/EstimoteIndoorLocationSDK/Resources/beacon_grey.png"
  install_resource "EstimoteIndoorSDK/EstimoteIndoorLocationSDK/Resources/beacon_grey@2x.png"
  install_resource "EstimoteIndoorSDK/EstimoteIndoorLocationSDK/Resources/beacon_grey@3x.png"
