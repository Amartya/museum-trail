...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        navigationBarAppearace.titleTextAttributes = [NSForegroundColorAttributeName:UIColor.black]  // Title's text color
    ...
    func shouldSaveApplicationState(_ application: UIApplication) -> Bool{
        return true
    }
    
    func shouldRestoreApplicationState(_ application: UIApplication) -> Bool{
        return true
    }
